...
| ST-006 | As a user, I want a clean and welcoming home screen with instructions so that I can quickly understand how to use the application. | 7 | 3 | N | -- | -- |
...
| ST-014 | As a developer, I want to implement development, test, and production CI/CD for the product. | 8 | 1 | N | -- | All |
